...
"""Tests for the deprecated `nw list-sequences` command.

NOTE: This command is deprecated. Use `nw list sequences` instead.
These tests are kept for compatibility but the command is no longer registered.
"""
